...
exports.postLogin = async (req, res) => {
    ...
    try {
        ...
        if (loginType === "student") {
            ...
            id = "s_admin_id";
            sql = `select ${id},first_name,last_name,email,password,role from ${loginType
                .split(" ")
                .join("_")} where email='${email}'`;
        } else if (loginType === "exam coord") {
            id = "coord_id";
            sql = `select ${id},first_name,last_name,email,password,phone,dept_id,address,role from ${loginType
                .split(" ")
                .join("_")} where email='${email}'`;
