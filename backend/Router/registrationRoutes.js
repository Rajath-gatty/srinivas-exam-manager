...
router.post(
  ...
  [
    ...
    body("regno")
      .trim()
      .isLength({ min: 5 })
      .withMessage("Enter valid Registration No."),
    body("gender")
      .trim()
      .isIn(["male", "female", "others"])
      .withMessage("Please specify Gender"),
    body("dob")
      .trim()
    ...
    body("bloodGroup")
      .trim()
      .notEmpty()
      .withMessage("Enter a valid blood group"),
    body("caste")
      .trim()
      .isLength({ min: 1 })
      .withMessage("Caste cannot be empty"),
    body("aadharNo")
      .trim()
    ...
    body("birthDistrict")
      .trim()
      .notEmpty()
      .withMessage("Birth District cannot be empty"),
    ...
    body("fatherOccupation")
      .trim()
      .notEmpty()
      .withMessage("Father Occupation cannot be empty"),
    body("fatherPhone")
      .trim()
      .isLength({ min: 10, max: 10 })
      .withMessage("Enter valid Phone number"),
    ...
    body("motherOccupation")
      .trim()
      .notEmpty()
      .withMessage("Mother Occupation cannot be empty"),
    body("motherPhone")
      .trim()
      .isLength({ min: 10, max: 10 })
      .withMessage("Enter valid Phone number"),
...
router.post(
  ...
  [
    ...
    body("facultyId")
      .trim()
      .isLength({ min: 5 })
      .withMessage("Enter valid Faculty ID")
      .custom(async (value) => {
        const result = await db.execute(
    ...
    body("teachingExp")
      .trim()
      .notEmpty()
      .withMessage("Enter Teaching experience"),
    body("joiningYear").trim().notEmpty().withMessage("Enter Joining Year"),
  ],
