...
body('phone').trim().isLength({min:10}).withMessage('Enter valid phone number'),
...
body('aadharNo').trim().isLength({min:12}).withMessage('Enter valid Aadhar number'),
...
body('pincode').trim().isLength({min:6}).withMessage('Enter valid pincode'),
...
body('fatherPhone').trim().isLength({min:10}).withMessage('Enter valid Phone number'),
...
body('motherPhone').trim().isLength({min:10}).withMessage('Enter valid Phone number'),
...
body('firstName').trim().isLength({min:3}).withMessage('Name must be atleast 3 characters long'),
body('facultyId').trim().isLength({min:5}).withMessage('Enter valid Faculty ID'),
body('gender').trim().isIn(['male','female','others']).withMessage('Please specify Gender'),
body('dob').trim().isDate({format:'DD/MM/YYYY'}).withMessage('Please Enter Valid Date'),
body('email').isEmail().withMessage('Enter valid Email ID'),
body('phone').trim().isLength({min:10}).withMessage('Enter valid phone number'),
...
body('country').trim().notEmpty().withMessage('Country cannot be empty'),
body('pincode').trim().isLength({min:6}).withMessage('Enter valid pincode'),
body('password').trim().isLength({min:5}).isAlphanumeric().withMessage('Password must contain atleast 5 characters'),
body('fatherName').trim().notEmpty().withMessage('Father name cannot be empty'),
body('fatherOccupation').trim().notEmpty().withMessage('Father Occupation cannot be empty'),
body('fatherPhone').trim().isLength({min:10}).withMessage('Enter valid Phone number'),
body('department').trim().notEmpty().withMessage('Select Department'),
