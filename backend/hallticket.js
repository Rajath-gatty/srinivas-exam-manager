module.exports = (studentArr,timetable,courseName) => {
        ...
        columns: [
           ...
           table: {
               ...
               body:[
                ...
                [{text:`${item.regno}`,margin:[0,7,0,0]},{text:'CCIS',margin:[0,7,0,0]},`${item.course_name?item.course_name:courseName}-Semester ${item.semester} \n Examination 2022-2023`],
               ]
           }
         }
       ] 
                      ...
                      widths:[20,'*',90,'*',110],
                       body:[
                           ...
                           ...timetable.map((item1,i)=> {
                            return [{text:i+1,margin:[0,10,0,0]},{text:item1.subj_code,margin:[0,10,0,0]},{text:item1.subj_name,margin:[0,10,0,5]},{text:item1.exam_date,margin:[0,10,0,0]},{text:item1.exam_time,margin:[0,3]}]
                        })
    ...
    const dd = {
        ...
        content: studentArr.map((item,index) => contentBody(item,index)),
        defaultStyle: {
            font:'Times',
        },
        styles:{
